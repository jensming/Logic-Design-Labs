...
HD_PWD='C:/Users/jensming/Desktop/James_CSE100L.xpr/HelloWorld/myLab1/myLab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myLab_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myLab_1.tcl
