...
HD_PWD='C:/Users/jensming/Desktop/James_CSE100L.xpr/HelloWorld/myLab1/myLab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myLab_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myLab_1.tcl -notrace
